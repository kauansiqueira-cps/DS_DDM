...
export email="kauan.siqueira2@etec.sp.gov.br"
export repositorio="https://github.com/kauansiqueira-cps/DS_PAM1.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="Favoritar_Palavras_aula-$(date +%Y%m%d)"
